 ...
 *
 * @authors Marcin Peczarski <marpe@mimuw.edu.pl>, Hubert Michalski <hm438596@students.mimuw.edu.pl>
 ...
 * @return Wskaźnik na strukturę przechowującą ciąg numerów lub NULL w przypadku
 *         gdy nie udało się alokować pamięci lub gdy wskaźnik na strukturę wskazuje na NULL.
 */
PhoneNumbers *phfwdGet(PhoneForward const *pf, char const *num);

/** @brief Wyznacza przekierowania na dany numer.
 * Wyznacza następujący ciąg numerów: jeśli istnieje numer @p x, taki że
 * przekierowanie numeru @p x zawiera numer @p num, to numer @p x
